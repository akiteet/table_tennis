...
function createRackState() {
  ...
  const positions = [
    ...
    { row: 3, col: -3 }, { row: 3, col: -1 }, { row: 3, col: 1 }, { row: 3, col: 3 },
    { row: 4, col: -4 }, { row: 4, col: -2 }, { row: 4, col: 0 }, { row: 4, col: 2 }, { row: 4, col: 4 }
  ];
  const numbers = [1, 9, 2, 10, 8, 3, 11, 4, 12, 5, 6, 13, 7, 14, 15];
...
server.listen(PORT, () => {
  console.log(`Chinese eight-ball online server running at http://localhost:${PORT}`);
});
